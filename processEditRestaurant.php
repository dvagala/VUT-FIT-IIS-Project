<?php
    ...
    $stmt->execute(array($_GET["name"], $_GET["description"], $_GET["town"], $_GET["street"], intval($_GET["zip"]), $_GET["phoneNumber"], $_GET["openingTime"], $_GET["closureTime"], intval($_GET["restaurantId"])));
